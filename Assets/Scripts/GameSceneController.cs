...
{
    public event EnemyDestroyHandler ScoreUpdateKill;
    ...
    public void AddObserver(IEndGameObserver obsrver)
    {
        endGameObservers.Add(obsrver);
    }
    ...
    private void Enemy_EnemyDestroyed(int pointValue)
    {
        ...
        if(ScoreUpdateKill != null)
            ScoreUpdateKill(totalPoints);
    }
