...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        gameSceneController.ScoreUpdateKill += GameSceneController_ScoreUpdateKill;

        EventBrocker.ProjectileOutOfBounds += EnableProjectile;
    ...
    private void GameSceneController_ScoreUpdateKill(int pointValue)
    {
        EnableProjectile();
    }
